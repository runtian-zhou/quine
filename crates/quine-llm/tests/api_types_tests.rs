...
fn anthropic_usage_deserializes_with_cache() {
    ...
    assert_eq!(
        ...
        "input_tokens should be exactly 100"
    );
    assert_eq!(
        usage.output_tokens, 50,
        "output_tokens should be exactly 50"
    );
    assert_eq!(
...
fn anthropic_response_deserializes_with_usage() {
    ...
    assert_eq!(
        ...
        1,
        "content should have exactly 1 block"
    );
    assert_eq!(
    ...
    assert_eq!(
        ...
        "usage input_tokens should be exactly 300"
    );
    assert_eq!(
        usage.output_tokens, 150,
        "usage output_tokens should be exactly 150"
    );
}
...
fn openai_usage_deserializes() {
    ...
    assert_eq!(
        ...
        "prompt_tokens should be exactly 200"
    );
    assert_eq!(
        usage.completion_tokens, 100,
        "completion_tokens should be exactly 100"
    );
}
...
fn openai_response_deserializes_with_usage() {
    ...
    assert_eq!(
        ...
        1,
        "choices should have exactly 1 entry"
    );
    assert_eq!(
    ...
    assert_eq!(
        ...
        "usage prompt_tokens should be exactly 500"
    );
    assert_eq!(
        usage.completion_tokens, 250,
        "usage completion_tokens should be exactly 250"
    );
}
